...
// @version      1.4
// @description  Надёжное управление YouTube через стрелки: ↑/↓ громкость, ←/→ перемотка с анимацией, Shift увеличивает шаг. Работает вне зависимости от фокуса, элемент анимации центрирован по видео.
// @author       YourName
// @license      MIT
